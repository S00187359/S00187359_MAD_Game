...
public class HighScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addHiScore(new HiScore("20 OCT 2020", "A ", 12));
        db.addHiScore(new HiScore("28 OCT 2020", "B ", 16));
        db.addHiScore(new HiScore("20 NOV 2020", "C ", 20));
        db.addHiScore(new HiScore("20 NOV 2020", "D ", 18));
        db.addHiScore(new HiScore("22 NOV 2020", "E ", 22));
        db.addHiScore(new HiScore("30 NOV 2020", "F ", 30));
        db.addHiScore(new HiScore("01 DEC 2020", "H ", 22));
        db.addHiScore(new HiScore("02 DEC 2020", "I ", 132));
    ...
    public void doRetry2(View view)
    {
        Intent retry = new Intent(this, MainActivity.class);

       retry.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        retry.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        retry.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        startActivity(retry);
    }
}